...
@section('content_header')
    <h1 class="m-0 text-dark">Roles Eliminados</h1>
@stop

@section('content')
    <div class="row mb-2">
        <div class="col-12 text-right">
            <a class="btn btn-success" href="{{route('rol.index',1)}}">Roles</a>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <div class="btn-group btn-group-sm">  
                          <a class="btn {{$css_btn_restaurar}}" rel="tooltip" data-placement="top" title="Eliminar" onclick="Restaurar({{$rol->id}})"><i class="far fa-trash-alt"></i></a>
                        </div>
                      </td>
                    </tr>
                    @php $c = $c + 1; @endphp
...
<script>
    ...
    $("#btn_usuario .nav-link").removeClass("active");
