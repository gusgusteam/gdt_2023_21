...
@section('content')
    <div class="row mb-2">
        ...
        <div class="col-6 text-right">
            <a class="btn btn-danger" href="{{route('rol.index',0)}}">eliminados</a>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card {{ config('adminlte.classes_index', '') }}">
                <div class="card-body ">
                    <h1 class="card-title {{ config('adminlte.classes_index_header', '') }} ">LISTA DE ROLES</h1> 
                </div>
                        ...
                        <tr>
                          ...
                          <td class="text-right">
                            <div class="btn-group btn-group-sm">  
                              <a class="btn btn-dark"  title="Permisos" href="{{route('rol.permisos',$rol->id)}}" ><i class="far fa-edit"></i></a>
                              <a class="btn {{$css_btn_edit}}" rel="tooltip" data-placement="top" title="Editar" onclick="Modificar({{$rol->id}})" ><i class="far fa-edit"></i></a>
                              <a class="btn {{$css_btn_delete}}" rel="tooltip" data-placement="top" title="Eliminar" onclick="Eliminar({{$rol->id}})"><i class="far fa-trash-alt"></i></a>
                            </div>
                          </td>
                        </tr>
                        @php $c = $c + 1; @endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="descripcion" name="descripcion" type="text" placeholder="ingrese una descripcion" aria-describedby="descripcion-error" aria-invalid="true"/>
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6">
                          <div class="form-group">
                              ...
                              <input class="form-control"  id="Mdescripcion" name="Mdescripcion" type="text" placeholder="ingrese una descripcion" aria-describedby="Mdescripcion-error" aria-invalid="true"/>
...
<script>
    ...
    function Modificar(id){
      $.ajax({
        url:"{{asset('')}}"+"rol/show/"+id, dataType:'json',
        success: function(resultado){
          $("#id_registro").val(resultado.rol.id);
          $("#Mnombre").val(resultado.rol.name); 
          $("#Mdescripcion").val(resultado.rol.descripcion);
